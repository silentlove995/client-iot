...
<c:url var="systemCardAPIDelete" value="/api/admin/card"/>
<c:url var="systemCardSearchURL" value="/admin/card"/>
<html>
<head>
    <meta charset="UTF-8">
    <meta name="viewport"
...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                <form:form class="col-xs-12" action="${systemCardSearchURL}" id="formSubmit" method="get"
                          >
                                ...
                                <div class="form-horizontal">
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            <label><b>Giá: </b></label>
                                            <div class="fg-line">
                                                <input type="number" class="form-control input-sm" id="price" name="price" value=""
                                                       />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="pull-right tableTools-container">
                            <div class="dt-buttons btn-overlap btn-group">
                                <a flag="info"
                                   ...
                                   data-toggle="tooltip"
                                   title="Add systemCard"
                                   href="<c:url value="/admin/card/edit"/>">
                                    <span>
...
<script type="text/javascript">
    ...
    function deleteBanner(data) {
        let url = '${systemCardAPIDelete}' + '?ids=' + $.each(data, function (index, value) {
        ...
        $.ajax({
            ...
            success: function (data) {
                window.location.href = "${systemCardSearchURL}?message=delete_success&page=1&pageSize=10";
            },
            error: function (data) {
                $("#closeModal").click();
                showError(data);
